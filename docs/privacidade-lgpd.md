...
SEFAZ PE: Certidão de Regularidade Fiscal (Móvel) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_pe_crf_movel@mcp.ai](mailto:sefaz_pe_crf_movel@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
